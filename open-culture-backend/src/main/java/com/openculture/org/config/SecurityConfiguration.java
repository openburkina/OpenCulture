...
import com.openculture.org.security.*;
import com.openculture.org.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/account/send-password-email").permitAll()
            ...
            .antMatchers("/api/artistes/**").permitAll()
            .antMatchers("/api/artistes").permitAll()
            .antMatchers("/api/regroupements").permitAll()
            .antMatchers("/api/account/reset-password/init").permitAll()
            .antMatchers("/api/account/reset-password/finish").permitAll()
            .antMatchers("/api/users").permitAll()
            .antMatchers("/api/artistes/search/{search}").permitAll()
            .antMatchers("/api/account/change-user-password").permitAll()
